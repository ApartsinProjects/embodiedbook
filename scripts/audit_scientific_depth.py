...
SPECIFICITY_TERMS = [
    ...
    "manipulator equation", "Lagrangian", "Euler-Lagrange", "Newton-Euler",
    "mass matrix", "Coriolis", "contact Jacobian", "friction cone",
    "complementarity", "semi-implicit Euler", "Runge-Kutta", "MJX",
    "Isaac Gym", "Brax", "contact solver",
