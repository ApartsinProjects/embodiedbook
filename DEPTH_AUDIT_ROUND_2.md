...
| 44 | COURSE-READY | `part-9-manipulation-locomotion-and-embodied-skills/module-43-grasping-and-dexterous-manipulation/section-43.3.html` | none | Keep. Spot-check only during publication QA. |
| 44 | COURSE-READY | `part-9-manipulation-locomotion-and-embodied-skills/module-43-grasping-and-dexterous-manipulation/section-43.4.html` | none | Keep. Spot-check only during publication QA. |
| 44 | COURSE-READY | `part-9-manipulation-locomotion-and-embodied-skills/module-44-tactile-and-visuo-tactile-learning/section-44.1.html` | none | Keep. Spot-check only during publication QA. |
| 44 | COURSE-READY | `part-9-manipulation-locomotion-and-embodied-skills/module-44-tactile-and-visuo-tactile-learning/section-44.2.html` | none | Keep. Spot-check only during publication QA. |
| 44 | COURSE-READY | `part-9-manipulation-locomotion-and-embodied-skills/module-44-tactile-and-visuo-tactile-learning/section-44.4.html` | none | Keep. Spot-check only during publication QA. |
| 44 | COURSE-READY | `part-9-manipulation-locomotion-and-embodied-skills/module-44-tactile-and-visuo-tactile-learning/section-44.5.html` | none | Keep. Spot-check only during publication QA. |
| 44 | COURSE-READY | `part-9-manipulation-locomotion-and-embodied-skills/module-46-humanoid-robots-and-whole-body-control/section-46.3.html` | none | Keep. Spot-check only during publication QA. |
| 44 | COURSE-READY | `part-9-manipulation-locomotion-and-embodied-skills/module-46-humanoid-robots-and-whole-body-control/section-46.5.html` | none | Keep. Spot-check only during publication QA. |
| 44 | COURSE-READY | `part-9-manipulation-locomotion-and-embodied-skills/module-47-drones-and-aerial-embodied-ai/section-47.1.html` | none | Keep. Spot-check only during publication QA. |
| 44 | COURSE-READY | `part-9-manipulation-locomotion-and-embodied-skills/module-47-drones-and-aerial-embodied-ai/section-47.2.html` | none | Keep. Spot-check only during publication QA. |
| 44 | COURSE-READY | `part-9-manipulation-locomotion-and-embodied-skills/module-47-drones-and-aerial-embodied-ai/section-47.3.html` | none | Keep. Spot-check only during publication QA. |
| 44 | COURSE-READY | `part-9-manipulation-locomotion-and-embodied-skills/module-47-drones-and-aerial-embodied-ai/section-47.4.html` | none | Keep. Spot-check only during publication QA. |
| 44 | COURSE-READY | `part-9-manipulation-locomotion-and-embodied-skills/module-48-autonomous-driving-as-embodied-ai/section-48.1.html` | none | Keep. Spot-check only during publication QA. |
| 44 | COURSE-READY | `part-9-manipulation-locomotion-and-embodied-skills/module-48-autonomous-driving-as-embodied-ai/section-48.3.html` | none | Keep. Spot-check only during publication QA. |
